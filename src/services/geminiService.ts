...
/**
 * Process document using Gemini AI (Client-side as per skill guidelines).
 * IMPORTANT: This requires GEMINI_API_KEY to be defined in the build environment (e.g., Vercel Secrets).
 */
export const processDocumentWithAI = async (
  ...
  if (!apiKey) {
    throw new Error("A chave GEMINI_API_KEY não foi encontrada. Certifique-se de configurá-la nas variáveis de ambiente do Vercel.");
  }
